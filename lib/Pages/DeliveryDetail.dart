                        ...
                        children: [
                          Padding(
                            ...
                            child: Align(
                              ...
                              child: Row(
                                children: [
                                  Text("NGN ${widget.delivery!.price.toString()}",
                                    style: TextStyle(
                                        fontSize: 12
                                    ),),
                                  Container(
                                    ...
                                    child: Center(
                                      child: Text(
                                        "${widget.delivery!.status}".capitalized(),
                                        style: TextStyle(
                                            fontSize: 12,
                            ...
                            children: [
                              Column(
                                ...
                                children: [
                                  ...
                                  Text("${widget.delivery!.itemName}", style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold),),
                                  Text("state",  style: TextStyle(fontSize: 12, color: Colors.black38),),
                                  Text("${widget.delivery!.state}", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 12,),)
                                ],
                              ),
                              // Spacer(),
                              Column(
                                ...
                                children: [
                                  ...
                                  Text("${widget.delivery!.mode}", style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold),),
